...
# ==============================================================================
#  ArttulOS Automated INSTALLER ISO Builder v26.0 (Correct UEFI File)
#
#  - MY SINCERE APOLOGIES. You were absolutely right. The previous script
#    tried to modify a file that does not exist (`BOOT.conf`).
#  - THE FIX: This script now correctly modifies `EFI/BOOT/grub.cfg` for UEFI
#    systems and `isolinux/isolinux.cfg` for BIOS systems, as is standard.
#  - The logic is now more precise, targeting the specific installation
#    menu entries to append the kickstart parameter.
#
...
# Generated by ArttulOS Builder v26.0 - Installer Kickstart
graphical
lang en_US.UTF-8
...
main() {
    ...
    echo -e "${BLUE}======================================================================${NC}"
    echo -e "${BLUE}  ArttulOS Automated INSTALLER ISO Builder v26.0                      ${NC}"
    echo -e "${BLUE}======================================================================${NC}"
    ...
    ( # --- Start Subshell for Safe Operations ---
        ...
        # 2. For UEFI systems (grub.cfg) - Modify the correct file
        ...
        echo -e "${GREEN}    UEFI (grub.cfg) configured correctly.${NC}"
        # --- END OF FIX ---
