...
# ==============================================================================
#  ArttulOS Automated INSTALLER ISO Builder v34.0 (Definitive Installer)
#
#  - This script's goal is to produce a standard INSTALLER ISO for consumer
#    hardware (supporting both legacy BIOS and UEFI), with Secure Boot disabled.
#  - It correctly modifies the Rocky Linux 9.6 installer ISO with custom
#    branding and the kernel-ml package.
#  - This is the final, correct version incorporating all previous bug fixes.
#
...
# Generated by ArttulOS Builder v34.0 - Installer Kickstart
graphical
lang en_US.UTF-8
...
# Use local repos on the ISO and the ELRepo for the custom kernel
...
# Standard Partitioning for consumer hardware
zerombr
...
# Custom kernel and support packages
kernel-ml
-kernel
elrepo-release
gnome-initial-setup
...
# 3. Correct paths in GRUB config for LVM installs (a common chroot issue)
...
main() {
    ...
    echo -e "${BLUE}======================================================================${NC}"
    echo -e "${BLUE}  ArttulOS Automated INSTALLER ISO Builder v34.0                      ${NC}"
    echo -e "${BLUE}======================================================================${NC}"
    ...
    ( # --- Start Subshell for Safe Operations ---
        ...
        # --- THE DEFINITIVE BOOTLOADER FIX ---
        # 1. For Legacy BIOS systems (isolinux.cfg)
        ...
        # 2. For UEFI systems (Modify the REAL grub.cfg inside efiboot.img)
