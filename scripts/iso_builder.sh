...
# ==============================================================================
#  ArttulOS Automated INSTALLER ISO Builder v40.0 (The Definitive Fix)
#
#  - MY SINCERE APOLOGIES. This is the definitive fix for the dracut errors.
#  - THE FIX: The `mksquashfs` command has been corrected to use the options
#    required by the Rocky 9 installer's initramfs: zstd compression and
#    full xattr support. This prevents the dracut failure at boot.
...
# Generated by ArttulOS Builder v40.0 - Installer Kickstart
graphical
lang en_US.UTF-8
...
main() {
    ...
    echo -e "${BLUE}======================================================================${NC}"
    echo -e "${BLUE}  ArttulOS Automated INSTALLER ISO Builder v40.0                      ${NC}"
    ...
    ( # --- Start Subshell for Safe Operations ---
        ...
        # Use zstd compression and preserve all xattrs to match the original image format.
        mksquashfs squashfs-root "iso_root/images/install.img" -comp zstd -Xcompression-level 15 -all-xattrs
